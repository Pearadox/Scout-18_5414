...
// Java Object _SHARED_ by Auto, Tele & Final
    public static matchData Match_Data = new matchData(match, team_num,
        ...
        final_lostParts, final_lostComms, final_defense_good, final_def_Lane, final_def_Block, final_def_Hopper, final_def_Gear, final_num_Penalties, final_comment, final_studID, final_dateTime);
